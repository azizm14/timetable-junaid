...
class Art{
  public:
  //accessable anywhere - public
  void printLandscape(){
    //Four methods to call the ASCII art for the project
    std::cout << R"(    
        _    .  ,   .           .
    *  / \_ *  / \_      _  *        *   /\'__        *
      /    \  /    \,   ((        .    _/  /  \  *'.
...
int main(){
  out_town();
  cout <<"welcome back you are now with in the main town."<<endl;
  
  // below to be called at the end of the code
  
  cout << "Askii art has been used from" << endl;
  cout << "https://www.asciiart.eu/" << endl;
  cout << "huge thanks to them!!"<<endl;
cout <<"Code creaters"<<endl;
cout<<"1.sunny - out of town\n2.luke main methods\n3.Hoa-lam - Combat sections\n4.hamaza & cameron & junaid databases";
return 0;
}
  
  //called from a main function all methods to to be called from main 
  //void Function - performs task all methods to be stored in void
